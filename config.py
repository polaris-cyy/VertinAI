...
class OptionParser():
    def __init__(self):
        ...
        self.parser.add_argument("--ocr_enhance_list", type=list, help="图像增强选项, 目前支持[sharpen, enhance, enlarge, super_resolution].")
        ...
        self.parser.add_argument("--invalide_char_list", type=list, help="用于强制过滤非法角色名")
